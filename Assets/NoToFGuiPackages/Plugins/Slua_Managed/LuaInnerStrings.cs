...
namespace SLua{
	public static class LuaInnerStrings
    {
#if !COC_PUBLISH //·¢²¼
...
";
        ...
        public static string classfunc = @"
local getmetatable = getmetatable
local setmetatable = setmetatable
local inherit_override_fun_map = setmetatable( {}, { __mode = 'kv', } ) 
local inherit_map = setmetatable( {}, { __mode = 'kv', } ) 
_G.inherit_override_fun_map = inherit_override_fun_map
_G.inherit_map = inherit_map
    ...
    setmetatable(class, 
        {
            ...
            __call = function(...)
                ...
                inherit_override_fun_map[r] = ret
                inherit_map[r] = ins_ret
...
";
        ...
        public static string resumefunc = @"
...
";
        ...
        public static string dumpstackfunc = @"
...
";
        ...
        public static string jit = @"if jit then require('jit.opt').start('sizemcode=256','maxmcode=256') for i=1,1000 do end end";
...
do
	...
	setmetatable(Quaternion,Quaternion)
        ...
        public static string PCallCSFunction = @"
local assert = assert
...
";
        ...
        public static string newindexfun = @"
local getmetatable=getmetatable
local rawget=rawget
local error=error
local type=type
